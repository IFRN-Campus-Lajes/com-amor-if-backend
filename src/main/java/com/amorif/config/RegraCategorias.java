...
public final class RegraCategorias {
    ...
    private static final List<Definicao> DEFINICOES = List.of(
            ...
            regra("Ordenação", "20 pontos por 100% de avaliações excelentes no bimestre",
            ...
            regra("Limpeza", "20 pontos por 100% de avaliações excelentes no bimestre",
            ...
            regra("Saúde", "1 ponto por aluno com plano de estudos", "Outros",
            ...
            regra("Saúde", "Pontos por alunos em projetos de pesquisa ou extensão",
            ...
            regra("Saúde", "50 a 300 pontos por divulgação dos processos seletivos",
